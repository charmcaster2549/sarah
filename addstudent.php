                    ...
                    <div class="paraAdd">
                        ...
                        <div class="middiv">
                            <div class="headerstud">
                                <h1 class="add">Add New Student</h1>
                            </div>
                            <div class="wrapperstud">
                                <form action="studentaccount.php" method="post" id="myForm">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <select name="year" id="" style="height: 38px;" required>
                                        ...
                                        <input type="text" name="units" style="width:117;" required></td>
                                    </tr>
                                    <tr>
                                        <td>Residence</td>
                                        <td>
