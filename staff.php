                ...
                <div class="right">
                    ...
                    <div class="search">
                        ...
                        <div class="search-container">
                            <input type="text" class="searchinput" id="searchinput" required>
                            <div id="results"></div>
                        </div>
                        <!-- </form> -->
                    </div>
                    <div class="encode">
                        <div class="encodeheader">
                            <div class="studname">Name: </div>
                            <div class="studcourse">Course & Year:</div>
                            <div class="place">Residence: </div>
                        </div>
                        <form id="transRecSubmit">
                        <div class="encodebody">
                            
                                
                                
                            <div class="resibo">
                                <label>Official Receipt</label>
                                <input type="text" class="receipt" required>
                            </div>
                            <div class="date">
                                <label>Date</label>
                                <input type="date" class="petsa" required>
                            </div>
                            <div class="amount">
                                <label>Amount</label>
                                <input type="number" class="amt" required>
                            </div>
                        ...
                        <div class="button">
                            <button class="submit">Submit</button>
                                <select name="type" id="type" class="type">
                                    ...
                                    <option value="2">SG Fund</option>
                                    <option value="3">Miscellaneous</option>
                                </select>
                                

                                <select name="ay" id="ay" class="ay">
                                    <option value="" id="">Academic Year</option>
                                </select>
                        </div>
                        </form>
                    ...
                    <div class="list">
                        <div class="list_left">
                            ...
                            <div class="list_payment">
                                ...
                                <table class="lista">
                                    ...
                                    <tbody id="transRecList" class="listabody">
                        ...
                        <div class="list_right">
                            <div class="list_summary" id="list_summary">
